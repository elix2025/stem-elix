...
router.get("/all", getAllCourses); // Changed from "/all" to "/" to match frontend calls
router.get("/by-title/:title", getCourseByTitle); // New route to get course by title/slug
