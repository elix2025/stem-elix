        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Ready to start your STEM journey? We’re here to help you unlock your potential
              and transform your future with cutting-edge education.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-slate-200 rounded-2xl shadow-xl p-6 sm:p-8 h-full">
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234567" className="text-slate-600 text-sm hover:text-violet-600 transition-colors">
                        +1 (555) 123-4567
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@stemelixu.com" className="text-slate-600 text-sm hover:text-fuchsia-600 transition-colors">
                        hello@stemelixu.com
                      </a>
                    </div>
                  </div>
