    ...
    <main className="bg-gradient-to-br from-slate-50 to-gray-100 min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-emerald-500/10 rounded-full blur-2xl animate-pulse delay-500"></div>
        </div>
          ...
          <div className="text-center text-white space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-emerald-400 to-green-400">
                  STEM Innovators
                </span>
              </h1>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-teal-50 text-teal-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
      ...
      <section
        id="team"
        className={`py-20 px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-teal-50 transition-all duration-1000 delay-400 ${
          isVisible.team
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-10"
        }`}
