            ...
            {[
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl
                           bg-gradient-to-r from-white to-gray-50 border border-gray-200 text-charcoal
                           hover:border-primary-blue hover:shadow-lg hover:shadow-primary-blue/10 transition-all duration-300
