...
const CourseCard = ({ course, index }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-primary-blue/10 to-cyan/20 rounded-full 
                      group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 animate-pulse"
      ></div>
      <div
        className="absolute bottom-6 left-4 w-6 h-6 bg-gradient-to-br from-cyan/10 to-primary-blue/20 rounded-full 
                      group-hover:scale-110 group-hover:-rotate-12 transition-all duration-500 animate-pulse delay-200"
      ></div>
      ...
      <div className="relative z-10 p-8 flex flex-col items-center justify-center h-56">
        ...
        <div className="relative mb-6">
          <div
            className="w-20 h-20 bg-gradient-to-br from-primary-blue/10 via-cyan/5 to-primary-blue/10 
          ...
          {/* Glow effect */}
          <div
            className="absolute inset-0 w-20 h-20 bg-gradient-to-br from-primary-blue/20 to-cyan/20 rounded-3xl 
        ...
        {/* Course Title */}
        <h3
          className="text-charcoal font-bold text-xl md:text-2xl text-center mb-4
        ...
        <div className="relative">
          <span
            className="px-4 py-2 bg-gradient-to-r from-primary-blue/10 to-cyan/10 
        ...
        >
          <svg
            className="w-6 h-6 text-primary-blue group-hover:text-cyan"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
...
export default function TinkrionShowcase() {
  ...
  return (
    <div className="w-full section-padding bg-gradient-to-br from-light-bg via-white to-blue-50/30 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div
            className="inline-flex items-center space-x-2 glass bg-primary-blue/10 backdrop-blur-sm
                          ...
                          text-sm font-medium mb-8 animate-slideDown"
          >
            <div className="w-2 h-2 bg-primary-blue rounded-full animate-pulse"></div>
            <span>Explore Our Courses</span>
          </div>

          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 animate-fadeIn">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className="h-56 bg-white rounded-2xl shadow-lg animate-pulse"
              >
                <div className="p-8 flex flex-col items-center justify-center h-full">
                  <div className="w-20 h-20 bg-gray-200 rounded-3xl mb-6"></div>
        ...
        <div className="text-center mt-16">
          <div
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-primary-blue/10 to-cyan/10 
